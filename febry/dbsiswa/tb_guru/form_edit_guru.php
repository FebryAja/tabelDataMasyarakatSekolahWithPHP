  ...
  <div class="container py-3">
    <header>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="../tb_karyawan/index.php">Karyawan</a>
                  </li>
      ...
      <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
        <h1 class="display-4 fw-normal">Edit Data Guru</h1>
    ...
    $query = mysqli_query($koneksi, "SELECT * FROM tb_guru WHERE id_guru='$id_guru'") or die(mysqli_error());
    while ($data = mysqli_fetch_array($query)) {
      ...
      <form action="proses_edit_guru.php" method="post">
        <div class="row">
          <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" id="disabledTextInput" class="form-control" name="id_guru"
          ...
          <div class="col-md-6 ms-auto">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="recipient-name" name="nik_guru"
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="recipient-name" name="nama_guru"
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="recipient-name" name="tempat_lahir_guru"
          ...
          <div class="col-md-6 ms-auto">
            <div class="mb-3">
              ...
              <input type="date" class="form-control" id="recipient-name" name="tanggal_lahir_guru"
        ...
        <div class="row">
                ...
                <div class="col">
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" id="inlineRadio1"
                        name="jenis_kelamin_guru" value="L" <?php if ($data['jenis_kelamin'] == 'L')
                        echo 'checked' ?> />
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio2"
                        name="jenis_kelamin_guru" value="P" <?php if ($data['jenis_kelamin'] == 'P')
                        echo 'checked' ?> />
              ...
              <div class="mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio1"
                       type="radio" name="golongan_darah_guru" value="A" <?php
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio2"
                       type="radio" name="golongan_darah_guru" value="B" <?php
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio2"
                       type="radio" name="golongan_darah_guru" value="AB" <?php
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio2"
                       type="radio" name="golongan_darah_guru" value="O" <?php
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="message-text" name="alamat_guru"><?php echo $data['alamat'] ?></textarea>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <select name="agama_guru" class="form-select">
              ...
              <div class="mb-3">
                <div class="row">
                  ...
                  <div class="col">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio1"
                       name="kewarganegaraan_guru" value="WNI" <?php if ($data['kewarganegaraan'] == 'WNI')
                  echo 'checked' ?> />
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio2"
                       name="kewarganegaraan_guru" value="WNA" <?php if ($data['kewarganegaraan'] == 'WNA')
                  echo 'checked' ?> />
