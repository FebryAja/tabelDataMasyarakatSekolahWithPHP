...
<body>
  <div class="container py-3">
    <header>
                  ...
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown ms-2 me-2">
                      <select class="form-select" name="kolom" style="max-width: 190px;"
                        ...
                        <option value="nik" <?php echo $nik; ?>>NIK guru</option>
      ...
      <!-- Modal Simpan -->
      <form action="proses_simpan_guru.php" method="POST">
                ...
                <form>
                  <fieldset>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="mb-3">
                          <label for="disabledTextInput" class="col-form-label fw-bold">ID guru</label>
                          <input type="text" id="disabledTextInput" name="id_guru" class="form-control" required />
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 ms-auto">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="nik_guru" id="recipient-name" required />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="nama_guru" id="recipient-name" required />
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="tempat_lahir_guru" id="recipient-name"
                            required />
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 ms-auto">
                        <div class="mb-3">
                          ...
                          <input type="date" class="form-control" name="tanggal_lahir_guru" id="recipient-name"
                            required />
                        </div>
                      </div>
                    </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="jenis_kelamin_guru" id="inlineRadio1"
                                  value="L" required />
                                <label class="form-check-label" for="inlineRadio1">Laki-Laki</label>
                              </div>

                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="jenis_kelamin_guru" id="inlineRadio2"
                                  value="P" required />
                      ...
                      <div class="col-md-6 ms-auto">
                        <div class="mb-3">
                          ...
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="golongan_darah_guru"
                    ...
                    <div class="mb-3">
                      ...
                      <textarea class="form-control" name="alamat_guru" id="message-text" required></textarea>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <select name="agama_guru" class="form-select" aria-label="Default select example">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="kewarganegaraan_guru"
      ...
      <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
        <h1 class="display-4 fw-normal">Tabel Data guru</h1>
        <p class="fs-5 text-muted">Tabel yang menampilkan data guru (Project Pelajaran PWP).</p>
      </div>
    </header>
            ...
            <tbody>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <a href="form_edit_guru.php?id_guru=<?php echo $data['id_guru']; ?>" type="button"
                  ...
                  <a href="proses_hapus_guru.php?id_guru=<?php echo $data['id_guru']; ?>"
                    onclick="return confirm('Anda yakin ingin menghapus data <?php echo $data['id_guru']; ?> ini ?')"
                    class="btn btn-outline-secondary">
