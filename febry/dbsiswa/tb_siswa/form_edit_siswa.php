  ...
  <div class="container py-3">
    <header>
      ...
      <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
        <h1 class="display-4 fw-normal">Edit Data Siswa</h1>
    ...
    $query = mysqli_query($koneksi, "SELECT * FROM tb_siswa WHERE id_siswa='$id_siswa'") or die(mysqli_error());
    while ($data = mysqli_fetch_array($query)) {
      ...
      <form action="proses_edit_siswa.php" method="post">
        <div class="row">
          <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" id="disabledTextInput" class="form-control" name="id_siswa"
          ...
          <div class="col-md-6 ms-auto">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="recipient-name" name="nik_siswa"
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="recipient-name" name="nama_siswa"
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="recipient-name" name="tempat_lahir_siswa"
          ...
          <div class="col-md-6 ms-auto">
            <div class="mb-3">
              ...
              <input type="date" class="form-control" id="recipient-name" name="tanggal_lahir_siswa"
        ...
        <div class="row">
                ...
                <div class="col">
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" id="inlineRadio1"
                        name="jenis_kelamin_siswa" value="L" <?php if ($data['jenis_kelamin'] == 'L')
                        echo 'checked' ?> />
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio2"
                        name="jenis_kelamin_siswa" value="P" <?php if ($data['jenis_kelamin'] == 'P')
                        echo 'checked' ?> />
              ...
              <div class="mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio1"
                       type="radio" name="golongan_darah_siswa" value="A" <?php
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio2"
                       type="radio" name="golongan_darah_siswa" value="B" <?php
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio2"
                       type="radio" name="golongan_darah_siswa" value="AB" <?php
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio2"
                       type="radio" name="golongan_darah_siswa" value="O" <?php
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="message-text" name="alamat_siswa"><?php echo $data['alamat'] ?></textarea>
        </div>
              ...
              <div class="mb-3">
                <div class="row">
                  ...
                  <div class="col">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio1"
                       name="kewarganegaraan_siswa" value="WNI" <?php if ($data['kewarganegaraan'] == 'WNI')
                  echo 'checked' ?> />
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" id="inlineRadio2"
                       name="kewarganegaraan_siswa" value="WNA" <?php if ($data['kewarganegaraan'] == 'WNA')
                  echo 'checked' ?> />
