...
<body>
  <div class="container py-3">
    <header>
                  ...
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown ms-2 me-2">
                      <select class="form-select" name="kolom" style="max-width: 190px;"
                        ...
                        <option value="id_karyawan" <?php echo $id_karyawan; ?>>ID Karyawan</option>
                        <option value="nik" <?php echo $nik; ?>>NIK Karyawan</option>
                        <option value="nama" <?php echo $nama; ?>>Nama Karyawan</option>
                      </select>
                    </li>
                  </ul>
      ...
      <!-- Modal Simpan -->
      <form action="proses_simpan_karyawan.php" method="POST">
                ...
                <form>
                  <fieldset>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <input type="text" id="disabledTextInput" name="id_karyawan" class="form-control" required />
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 ms-auto">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="nik_karyawan" id="recipient-name" required />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="nama_karyawan" id="recipient-name" required />
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="tempat_lahir_karyawan" id="recipient-name"
                            required />
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 ms-auto">
                        <div class="mb-3">
                          ...
                          <input type="date" class="form-control" name="tanggal_lahir_karyawan" id="recipient-name"
                            required />
                        </div>
                      </div>
                    </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="jenis_kelamin_karyawan"
                      ...
                      <div class="col-md-6 ms-auto">
                        <div class="mb-3">
                          ...
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="golongan_darah_karyawan"
                    ...
                    <div class="mb-3">
                      ...
                      <textarea class="form-control" name="alamat_karyawan" id="message-text" required></textarea>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <select name="agama_karyawan" class="form-select" aria-label="Default select example">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="kewarganegaraan_karyawan"
      ...
      <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
        <h1 class="display-4 fw-normal">Tabel Data Karyawan</h1>
        <p class="fs-5 text-muted">Tabel yang menampilkan data karyawan (Project Pelajaran PWP).</p>
      </div>
    </header>
      ...
      <div class="table-responsive">
        <table class="table text-center">
          ...
          if (isset($_POST['kata_kunci'])) {
            ...
            $sql = "select * from tb_karyawan where $kolom like '%" . $kata_kunci . "%' order by id_karyawan asc";
            ...
            <tbody>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <a href="form_edit_karyawan.php?id_karyawan=<?php echo $data['id_karyawan']; ?>" type="button"
                  ...
                  <a href="proses_hapus_karyawan.php?id_karyawan=<?php echo $data['id_karyawan']; ?>"
                    onclick="return confirm('Anda yakin ingin menghapus data <?php echo $data['id_karyawan']; ?> ini ?')"
                    class="btn btn-outline-secondary">
        ...
        <div class="col-6 col-md">
          ...
          <ul class="list-unstyled text-small">
            <li class="mb-1"><a class="link-secondary text-decoration-none"
                href="https://www.instagram.com/24peb_/">Instagram</a></li>
          </ul>
        </div>
      </div>
    </footer>
